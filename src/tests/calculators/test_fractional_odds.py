...
class TestFractionalOdds:
    ...
    def test_roundtrip_conversion(self):
        ...
        original_decimals = [fractional_to_decimal(n, d) for n, d in original_odds]
        converted_decimals = [fractional_to_decimal(n, d) for n, d in converted_odds]
    ...
    def test_common_fractional_odds(self):
        ...
        for (num, den), expected_prob in common_odds:
            ...
            probs = remove_vig_fractional(odds)
