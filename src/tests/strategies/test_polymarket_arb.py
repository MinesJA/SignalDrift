...
from src.strategies.polymarket_arb import calculate_orders, _recurs_build_orders, _build_order
from src.models import SyntheticOrderBook, SyntheticOrder, Order, OrderType
...
class TestRecursBuildOrders:
    ...
    def test_minimum_size_requirement(self):
        ...
        a_orders = [SyntheticOrder(side="ask", price=0.45, size=0.5, timestamp=1000)]  # Below minimum
        b_orders = [SyntheticOrder(side="ask", price=0.50, size=0.8, timestamp=1000)]   # Below minimum
...
class TestPolymarketArbIntegration:
    ...
    def test_timestamp_consistency(self):
        ...
        timestamps = set(order.timestamp for order in orders)
